...
+ **Vicious competition.** Vicious competition can occur between big platforms or between advertisers and usually comes with the winner's curse. Due to the lack of common ground, big content distribution platforms often have to bid for hot IPs with insane high prices, driving up the cost of the bid winner and at the same time, leaving the small and medium-sized platforms no choice but to turn to pirated media. On the advertisers' side, they bid for users' attention on a central platform and will suffer from the snowballing marketing cost as well. Their spending is largely obscured by the platform and their link to the end users are fragile and vulnerable to their relationship with the central distributor channel. 
